import { Leaf, Mail, MoveRight, Tag, Truck } from 'lucide-react'
import Image from 'next/image'
import React from 'react'

export default function NewsLetterSection() {
    return (
        <div className="relative grid lg:grid-cols-5 gap-8 p-8 lg:p-14 container mx-auto">
            <div className="lg:col-span-3 space-y-6 container mx-auto">
                        ...
                        <div className='relative space-y-5'>
                            ...
                            <div className='flex flex-col gap-3 pt-2'>
                                <a href="#" className='flex items-center gap-3 bg-white/10 hover:bg-white/15 backdrop-blur-sm border border-white/10 px-4 py-3 rounded-xl transition-all hover:scale-[1.02]'>
                                    <Image src="https://cdn.jsdelivr.net/npm/simple-icons/icons/apple.svg" width={20} height={20} alt='App store icon' />
                                ...
                                <a href="#" className='flex items-center gap-3 bg-white/10 hover:bg-white/15 backdrop-blur-sm border border-white/10 px-4 py-3 rounded-xl transition-all hover:scale-[1.02]'>
                                    <Image src="https://cdn.jsdelivr.net/npm/simple-icons/icons/googleplay.svg" width={20} height={20} alt='App store icon' />
                                    <div className='text-left'>
